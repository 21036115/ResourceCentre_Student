...
public class ResourceCentreTest {
	...
	public void setUp() throws Exception {
		...
		cc2 = new Camcorder("CC0012", "Sony DSC-RX100M7"f, 20);
	...
	@Test
	public void testRetrieveAllChromebook() { // coby
		//fail("Not yet implemented");
		// write your code here
		// Test if there is a valid list to add to
		assertNotNull("Test if there is a valid list to add to", chromebookList);
	...
	@Test
	public void testDoReturnChromebook() { // jes
		//fail("Not yet implemented");
		// write your code here
			assertNotNull("Test if there is valid Chromebook arraylist to add to", chromebookList);
			ResourceCentre.addChromebook(chromebookList, cb1);
